...
enum TA_CollisionType {
    ...
    TA_COLLISION_ATTACK = (1 << 3),
    TA_COLLISION_BOMB = (1 << 4),
    TA_COLLISION_CHARACTER = (1 << 5),
    TA_COLLISION_PUSHABLE = (1 << 6),
    TA_COLLISION_SPRING = (1 << 7),
    TA_COLLISION_MOVING_PLATFORM = (1 << 8),
    TA_COLLISION_WATER = (1 << 9),
    TA_COLLISION_NAPALM = (1 << 10),
    TA_COLLISION_DRILL = (1 << 11),
    TA_COLLISION_CONVEYOR_BELT_LEFT = (1 << 12),
    TA_COLLISION_CONVEYOR_BELT_RIGHT = (1 << 13),
    TA_COLLISION_TARGET = (1 << 14)
};
