...
enum TA_CollisionType {
    ...
    TA_COLLISION_HELMET = (1 << 19),
    TA_COLLISION_NO_BREAK = (1 << 20),
    TA_COLLISION_DYNAMIC_SOLID = (1 << 21),
};

constexpr int TA_GENERIC_ATTACK = TA_COLLISION_ATTACK | TA_COLLISION_HELMET;
